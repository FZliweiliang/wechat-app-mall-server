...
router.post('/v1/admin/addItem',intercept.admin,multipartMiddleware,homeApi.addItem) //添加商品

router.post('/v1/admin/addItem',intercept.admin,adminApi.addClass) //添加分类
